...
class MyPhysicsGame extends Forge2DGame {
  MyPhysicsGame()
      : super(
          ...
          camera: CameraComponent.withFixedResolution(
            width: ui.PlatformDispatcher.instance.implicitView!.physicalSize.width / ui.PlatformDispatcher.instance.implicitView!.devicePixelRatio,
            height: ui.PlatformDispatcher.instance.implicitView!.physicalSize.height / ui.PlatformDispatcher.instance.implicitView!.devicePixelRatio,
          ),
        );
  ...
  Future<void> addPlayer() async => world.add(
        Player(
          Vector2(camera.visibleWorldRect.left * 2 / 3, -5),
